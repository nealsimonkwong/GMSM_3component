...
function [Y, sig_lnY, sig_0, tau_0] = GA_2011(M, Rrup, Vs30, FRV, FNM, T)
%{
...
Provides GM predictions for medians and standard deviations of 
...
Rx = Rrup;
dip = 90; 
Ztor = 0; % Assume motion at top
Z10 = 0; % Value here doesn't matter if SS assumed
W = 15; % Value here doesn't matter if SS assumed
FAS = 0;
FHW = 0;
...
FVS30_rock = 0;
T_rock = 0;
PGAhat1100 = AS_2008_nga_mod_wCD(M, Vs30_rock, T_rock, Rrup, Rjb, Rx, dip, Ztor, Z10, W, FRV, FNM, FAS, FHW, FVS30_rock);
