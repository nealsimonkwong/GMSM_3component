...
function [rho_total, rho_between, rho_within] = GKAS_2016_corr(Ta, Tb, M, Rrup, Rjb, Rx, FRV, FNM, dip, Vs30, region, Sj)
%{
...
Provides correlations between SA_V(T_V) and SA_V(T_V)
...
% Std dev for V at Ta
[~, sig_Va, tau_Va, phi_Va] = gmpmV_BC2016(M, Rrup, Rjb, Rx, FRV, FNM, dip, Vs30, region, Sj, Ta);

% Std dev for V at Tb
[~, sig_Vb, tau_Vb, phi_Vb] = gmpmV_BC2016(M, Rrup, Rjb, Rx, FRV, FNM, dip, Vs30, region, Sj, Tb);
