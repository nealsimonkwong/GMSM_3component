function [Y, sig_lnY, tau_lnY, phi_lnY] = gmpmV_BC2016(M,Rrup,Rjb,Rx,FRV,FNM,dip,Vs30,region,Sj,T,W,Ztor,Z2p5,Zhyp)
% By: Neal Simon Kwong, nealsimonkwong@berkeley.edu
% Last modified: 6/21/19 to make code more efficient
%                8/13/18 to fix bug on interpolation of std dev vs M
%                4/27/18
% 
...
% %     tau_lnY = tau_2(ip) + (tau_1(ip)-tau_2(ip))/(5.5-M);
...
% %     phi_lnY = phi_2(ip) + (phi_1(ip)-phi_2(ip))/(5.5-M);
